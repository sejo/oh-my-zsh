...
@curl -L https://raw.github.com/sejo/oh-my-zsh/master/tools/install.sh | sh@

h4. via `wget`

@wget --no-check-certificate https://raw.github.com/sejo/oh-my-zsh/master/tools/install.sh -O - | sh@
...
1. Clone the repository
  ...
  @git clone git://github.com/sejo/oh-my-zsh.git ~/.oh-my-zsh@
...
** Take a look at the "current themes":https://wiki.github.com/robbyrussel/oh-my-zsh/themes that come bundled with _Oh My Zsh_.
